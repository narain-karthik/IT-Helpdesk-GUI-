#!/usr/bin/env python3
"""
GTN Engineering IT Helpdesk - GUI Launcher
...
class HelpDeskLauncher:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("GTN Engineering IT Helpdesk - Server Manager")
    ...
    def start_server(self):
        ...
        try:
            ...
            env['FLASK_SECRET_KEY'] = 'gtn-helpdesk-secret-key-2025'
